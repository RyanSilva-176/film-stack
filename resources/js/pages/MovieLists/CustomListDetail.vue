<template>
  ...
  <AppLayout>
    <div class="min-h-screen bg-gray-950 overflow-x-hidden">
      <!-- Page Header -->
      <div class="bg-gradient-to-r from-purple-600/20 to-purple-500/20 border-b border-purple-500/30">
          ...
          <div class="flex items-start justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p v-if="customList?.description" class="text-gray-300 mt-1">
                  {{ customList.description }}
                </p>
                <p v-if="!loading && customList" class="text-gray-400 text-sm mt-1">
      ...
      <main class="container mx-auto px-4 py-8 md:py-12 max-w-full">
        ...
        <div v-if="loading" class="flex items-center justify-center py-12">
          <div class="text-center space-y-4">
            ...
            <p class="text-gray-400">Carregando lista...</p>
          </div>
        </div>
        ...
        <div v-else-if="error" class="flex items-center justify-center py-12">
          <div class="text-center space-y-4">
            ...
            <p class="text-gray-400">Erro ao carregar lista</p>
            <button
        ...
        <div v-else-if="!listMovies.length" class="flex items-center justify-center py-12">
          <div class="text-center space-y-4 max-w-md">
            ...
            <h2 class="text-xl font-semibold text-white">Lista vazia</h2>
...
import { useUserListsStore, type ListFilters, type MovieListItem, type MovieList } from '@/stores/userLists';
...
import { 
  faList, faCompass, faChevronLeft, faChevronRight, faInfoCircle, 
  faCheck, faExchangeAlt, faTrash, faFilm, faCheckSquare, faTh,
  faSearch, faTimes, faPlus, faEllipsisH, faCheckCircle, faEdit,
  faShareAlt
...
const availableDestinationLists = computed(() => 
  userListsStore.lists.filter(list => list.id !== customList.value?.id)
);
...
const confirmationMessage = computed(() => 
  `Tem certeza que deseja excluir a lista "${customList.value?.name}"? Esta ação não pode ser desfeita.`
);
