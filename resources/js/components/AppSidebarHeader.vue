...
<template>
    <header
        class="flex h-16 shrink-0 items-center gap-4 border-b border-sidebar-border/70 bg-background px-6 transition-[width,height,left] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:fixed md:top-0 md:z-30 md:bg-background/80 md:px-4 md:backdrop-blur-md"
        :class="{
    ...
    >
        ...
        <!-- Right side: Search -->
        <div class="flex min-w-0 flex-1 justify-end" :class="['md:mr-64', 'md:group-has-data-[state=collapsed]/sidebar-wrapper:mr-0']">
            <SearchHeader class="w-full max-w-xs md:max-w-sm" />
        </div>
    </header>
