    ...
    <section class="movie-carousel">
        ...
        <div class="relative" ref="carouselRef">
            ...
            <div
                ...
                ref="scrollContainer"
                class="scrollbar-hide flex cursor-grab gap-6 overflow-x-auto scroll-smooth px-4 pb-4 active:cursor-grabbing sm:px-6 lg:px-8"
...
const itemsPerView = computed(() => {
    ...
    if (width < 640) return 2.2; // mobile
    if (width < 768) return 2.8; // small tablet
    if (width < 1024) return 3.5; // tablet
    if (width < 1280) return 4.2; // desktop
    return 5.2; // large desktop
});
...
const updateScrollState = (): void => {
    ...
    canScrollLeft.value = scroll > 5; // Small tolerance
...
// Enhanced drag functionality for mobile
...
const drag = (e: MouseEvent | TouchEvent): void => {
    ...
    const walk = (x - startX.value) * 1.5; // Responsive scroll speed
...
onMounted(() => {
    ...
    // Initial scroll state after mount
